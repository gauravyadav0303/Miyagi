...
// })
    ...
    return ( 
          ...
          <div>
            ...
            >
              <span className="text-black">
                {"<"}Your Bills,<br/><span className="text-[#9F32B2]">OUR </span>
                Responsibility{">"}
              </span>  
            </h1>
          </div>
        ...
        >
          ...
          <motion.button className=" min-w-[160px] min-h-[50px] font-poppins font-medium cursor-pointer text-[16px] rounded-3xl  border-2 p-2 text-white bg-[#9F32B2] "
